...
data_2d.T_left_total = vectorize_signal(out.logs_T_left_total.Data, N);
data_2d.T_right_total = vectorize_signal(out.logs_T_right_total.Data, N);
data_2d.delta_T_lr = vectorize_signal(out.logs_delta_T_lr.Data, N);
